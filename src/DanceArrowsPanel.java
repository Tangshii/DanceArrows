...
public class DanceArrowsPanel extends JPanel
{
	...
	public DanceArrowsPanel()
	{
		...
		// images for arrow
		up = new ImageIcon("src/DanceArrowsImages/up.png");
		down = new ImageIcon("src/DanceArrowsImages/down.png");
		left = new ImageIcon("src/DanceArrowsImages/left.png");
		right = new ImageIcon("src/DanceArrowsImages/right.png");
		
		// images for grayed out arrows
		upgrey = new ImageIcon("src/DanceArrowsImages/upgrey.png");
		downgrey = new ImageIcon("src/DanceArrowsImages/downgrey.png");
		leftgrey = new ImageIcon("src/DanceArrowsImages/leftgrey.png");
		rightgrey = new ImageIcon("src/DanceArrowsImages/rightgrey.png");
